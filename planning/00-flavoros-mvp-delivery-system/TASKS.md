...
# FlavorOS MVP Task Index

Canonical task details live in `task_map.yaml`. These inline fields make the work visible to Obsidian Dataview without forcing one note per task before the workflow stabilizes.
